...
require 'controladores/victimas.php';
...
$recursos_existentes = array('denuncias', 'usuarios', 'victimas');
...
$metodos_validos = array('get', 'post', 'put', 'delete');
...
// Ejecutar el método del recurso
if (method_exists($recurso, $metodo)) {
    $respuesta = call_user_func(array($recurso, $metodo), $peticion);
    $vista->imprimir($respuesta);
} else {
    // Método no encontrado en el recurso
    throw new ExcepcionApi(ESTADO_METODO_NO_PERMITIDO, "El método solicitado no existe en este recurso");
}
